...
//------------------------------------------------------------------------------------------------//
    ...
    public function actionIndex() {
        ...
        $admitHN = Yii::$app->db->createCommand("SELECT visit_hn FROM tmp_ipd_visit")->queryScalar();
        $admitVN = Yii::$app->db->createCommand("SELECT visit_vn FROM tmp_ipd_visit")->queryScalar();
        $admitDay = Yii::$app->db->createCommand("SELECT admit_day FROM tmp_ipd_visit")->queryScalar();
...
//------------------------------------------------------------------------------------------------//
    ...
    public function actionActivateAccount($token) {
        ...
        if ($user->activateAccount()) {
            Yii::$app->session->setFlash('success', 'Success! You can now log in. 
                Thank you ' . Html::encode($user->username) . ' for joining us!');
        } else {
            Yii::$app->session->setFlash('error', '' . Html::encode($user->username) . ' your account could not be activated, 
                please contact us!');
        }
